...
def DCR_admin():
    ...
    home_btn = Button(sidebar, text="Home", command=onclick_home_btn)
    home_btn.place(x=50, y=100)

    record_btn = Button(sidebar, text="Reservation Records", command=onclick_record_btn)
    record_btn.place(x=10, y=200)
 
    
    trainer_btn = Button(sidebar, text="Tariner Details", command=onclick_trainer_btn)
    trainer_btn.place(x=20, y=320)
...
# ----------- SIDE FRAME --------------
    ...
    # ===================== SIDEBAR BUTTONS =====================
    user_home_btn = Button(sidebar, text= "Home", command=onclick_user_home_btn)
    user_home_btn.place(x=50, y=100)
 

    reservation_btn = Button(sidebar, text="Your reservations", command=onclick_reservation_btn)
    reservation_btn.place(x=10, y=200)
